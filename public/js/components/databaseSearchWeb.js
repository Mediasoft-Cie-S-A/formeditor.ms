...
function RenderDataSearchWeb(main)
{
    ...
    jsonData.forEach(field => {
            ...
            var html="<div class='searchMain' id='search_"+field.apiId+ Date.now()+"' >";
            html+="<div class='search' id='search_"+field.apiId+"_searchDiv'>";
            html+="<input type='text' id='search_"+field.apiId+"_input' list='searchList' placeholder='"+field.fieldName+"'  autocomplete='off' ";
            ...
            html+="<div id='search_"+field.apiId+ Date.now()+"_autocomplete' class='autocomplete-results'>";
            html+="</div></div></div>";
