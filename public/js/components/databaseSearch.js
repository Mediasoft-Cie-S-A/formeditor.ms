...
function gridSearch(event)
{
    ...
    var gridDivs = document.querySelectorAll('div[tagname="dataGrid"]');
    // for each grid div call the searchGrid function


    gridDivs.forEach(gridDiv => {
        const gridID = gridDiv.getAttribute("id");
        searchGrid(filedName, operator, searchValue, gridID);
    });
}
